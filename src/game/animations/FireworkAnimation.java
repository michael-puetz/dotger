...
public class FireworkAnimation extends LineStarAnimation {

    public FireworkAnimation(double posX, double posY, double size, double speed, Color color, int gameTickDelay) {
    ...
    public void animate(double speedChangeFactor) {
        if (animationTickCounter == 0) {
            GAME_SOUNDS.playSound(GameSounds.FIREWORK_SOUND);
        }
