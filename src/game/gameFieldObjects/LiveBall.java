...
public class LiveBall extends GameBall {

	public LiveBall() {
		this(0, 0, new CircleAngle());
	}
	
	public LiveBall(double posX, double posY, CircleAngle direction) {
		super(posX, posY, LIVEBALL_RADIUS, direction, LIVEBALL_SPEED, GameColors.LIVEBALL);
	}

	@Override
	public GameFieldObject getInstance(double posX, double posY, CircleAngle direction) {
		return new LiveBall(posX, posY, direction);
	}
